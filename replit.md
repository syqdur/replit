...
- **MediaModal Close Button Fix**: Enhanced close button visibility in MediaModal with increased z-index (z-50), improved contrast with darker background, and added shadow effects to ensure the X button is always visible when viewing pictures opened from notifications
